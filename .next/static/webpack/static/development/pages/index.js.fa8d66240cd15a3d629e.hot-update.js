...
})(["", " color:#68bccf;font-size:2.5rem;@media(min-width:768px){font-size:3.5rem;}@media(min-width:1024px){font-size:4.5rem;}"], fontMono);
...
})(["", " color:#656778;font-size:2rem;@media(min-width:768px){font-size:3rem;}@media(min-width:1024px){font-size:4rem;}"], fontMono);
function Title(_ref) {
...
//# sourceMappingURL=index.js.fa8d66240cd15a3d629e.hot-update.js.map