  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    Object(_src_components_utils_fingerprint__WEBPACK_IMPORTED_MODULE_3__["getFingerprint"])().then(function (res) {
      ...
      if (res !== []) {
        ...
        var _hashedFingerPrint = md5__WEBPACK_IMPORTED_MODULE_2___default()(res);

        setFingerprint(_hashedFingerPrint); // @ts-ignore

        console.log(objectsToString(res));
      }
    });
  }, [fingerprint]);
  return __jsx(Main, {
...
//# sourceMappingURL=index.js.57a0e0a651ac7b28d3d3.hot-update.js.map